...
This is Part 1 of the Velotix Files. [Part 2](/posts/velotix-the-ceo/) profiles the CEO. [Part 3](/posts/velotix-marketing-machine/) examines the marketing machine. [Part 4](/posts/velotix-the-takedown/) documents the DMCA takedown notice filed against this post.
...
The campaign was distributed by [PipelBiz](https://pipelbiz.com/), an ISA-licensed crowdfunding platform, through at least six downstream channels — financial content sites, real estate landing pages, and the [Abu Ali Express](https://abualiexpress.com/heb112626/) Telegram channel, which has 598,000 subscribers and primarily covers Middle Eastern military affairs. The full distribution network is examined in [Part 3](/posts/velotix-marketing-machine/).

On one channel, CEO Dr Adi Hod was described as having "registered exits of over $100 million." His only known prior company sold for approximately $200,000 — a discrepancy of a factor of five hundred ([Part 2](/posts/velotix-the-ceo/)). On the [Calcalix page](https://web.archive.org/web/20260121050014/https://calcalix.co.il/pipelbiz-velotix-ob/) — labelled תוכן שיווקי (sponsored content) — the company was said to be "growing at a dizzying pace." Calcalix disclosed in its footer that it publishes advertising content "AS-IS, without verifying its truthfulness."
...
The [lawsuit](https://www.court.gov.il/) (ת"א 21105-03-26, Magistrate Court, Tel Aviv-Jaffa) includes WhatsApp messages between the consultant and Hod. According to the lawsuit appendices, the messages show the following sequence of events.
...
According to the [archived Calcalix page](https://web.archive.org/web/20260121050014/https://calcalix.co.il/pipelbiz-velotix-ob/), Velotix was being marketed to angel investors as a company "growing at a dizzying pace" during the same period.
...
A commenter on the [TheMarker article](https://www.themarker.com/technation/2026-03-09/ty-article/.highlight/0000019c-d2b9-d8a3-a59e-defb66630000), writing under the handle "Lifting the Curtain," stated: "All so that Dr Adi Hod could fly first class and stay in luxury hotels" (הכל כדי שד"ר עדי הוד יוכל לטוס במחלקה ראשונה ולבלות במלונות יוקרה).
...
The company extract also reveals a registered charge: First International Bank of Israel holds a first-priority security lien on Velotix's cash deposits, secured at 125,000 NIS. The same bank is listed as a "customer" on Sarona Ventures' [TechShield](https://techshield.sarona.vc/) investment platform ([Part 2](/posts/velotix-the-ceo/)).
...
The Velotix [website](https://www.velotix.ai/) remains fully live as of this writing. It presents the company as healthy: "Book a Demo," "Instant, Compliant Data Access without Compromise." The [About Us](https://www.velotix.ai/about-us/) page still lists Uriel Ekstein as "Co-founder & CBDO." Ekstein was fired in November 2025 and is now petitioning to put the company into insolvency.
